...
export default function AddDamageSheet({ onPhotoSelected, onClose }: AddDamageSheetProps) {
  ...
  return (
    <div className="damage-sheet-root" role="dialog" aria-modal="true" aria-label="Add damage photo">
      ...
      <div className="damage-sheet">
        ...
        <div className="damage-sheet__title">Add damage photo</div>
        ...
        <button type="button" className="damage-sheet-row" onClick={() => cameraRef.current?.click()}>
          ...
          <span>
            ...
            <div className="damage-sheet-row__sub">Opens rear camera · best for on-site intake</div>
          </span>
        </button>
        ...
        <button type="button" className="damage-sheet-row" onClick={() => libraryRef.current?.click()}>
          ...
          <span>
            ...
            <div className="damage-sheet-row__sub">Choose from camera roll or albums</div>
          </span>
        </button>
